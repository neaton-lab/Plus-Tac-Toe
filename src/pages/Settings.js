        ...
        <body className='w-full h-full md:h-screen'>
            ...
            <main class="flex flex-col justify-center mt-14">
                <label class="inline-flex justify-center items-center mb-20">
                    <input type="checkbox" checked={debugChecked} onChange={handleDebug} class="form-checkbox w-9 h-9 md:h-12 md:w-12" />
                    <span class="ml-4 text-4xl md:text-7xl">Debug Mode</span>
                </label>
