        ...
        <body className='overflow-scroll'>
            ...
            <div>
                <ol className='text-3xl md:text-5xl mx-[75px] md:mx-[300px] my-20 list-decimal'>
                    ...
                    <li className='my-10'>If a region has no more empty tiles and no winner, then no player can win that region</li>
                    <li className='my-10'>Once a player has won enough regions that it is impossible for them to lose (i.e. if one player wins 5 regions in a 2 player game), that player has won the game.</li>
                    <li className='my-10'>Once a player has claimed a tile, the next player in the turn order goes. If the player was the last in the turn order, it goes back to the first player</li>
                </ol>
            </div>
        </body>
    );
