      ...
      <div className="flex flex-col items-center">
        ...
        <div className='flex w-screen justify-center'>
          ...
          <Link to='/game'> {/* link to game page */}
            <button className='absolute -translate-x-1/2 translate-y-1/2 md:bottom-[100px] md:w-[300px] bg-gray-400 hover:bg-gray-500 text-gray-800 text-3xl md:text-6xl font-bold mt-[60px] 
          ...
          <div className='flex flex-row md:flex-col absolute bottom-0 md:absolute md:w-screen md:items-end'>
            ...
            <Link to="/help"> {/* link to help page. Icon from Hero Icons Icon-Question-Mark-Circle */}
              <button className='absolute translate-x-14 md:-translate-x-2 bottom-0 md:bottom-[50px] text-center right-0 text-gray-700  bg-gray-400 hover:bg-gray-500 px-2 py-2 md:px-3 md:py-3 m-5 mr-0 rounded-full'>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
