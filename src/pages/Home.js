        ...
        <div className='flex w-screen justify-center'>
          ...
          <div className='flex flex-row md:flex-col absolute bottom-0 md:absolute md:w-screen md:items-end'>
            ...
            <Link to="/settings"> {/* link to settings page. Icon from Hero Icons Icon-Cog  */}
              <button className='md:absolute md:bottom-[150px] text-center right-0 text-gray-700 bg-gray-400 hover:bg-gray-500 px-2 py-2 md:px-3 md:py-3 m-5 mr-10 rounded-full'>
            ...
            <Link to="/help"> {/* link to help page. Icon from Hero Icons Icon-Question-Mark-Circle */}
              <button className='md:absolute md:bottom-[50px] right-0 text-gray-700  bg-gray-400 hover:bg-gray-500 px-2 py-2 md:px-3 md:py-3 m-5 mr-10 rounded-full'>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
